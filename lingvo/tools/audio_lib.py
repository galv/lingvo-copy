...
def DecodeToWav(input_bytes, fmt):
  # For some crazy reason, sox will output a length of 2**31 only when
  # you have an mp3 input from stdin and a wav output to stdout, both
  # via pipes. Why? I have no idea. This cannot be reproduced from
  # bash. I workaround this via using NamedTemporaryFile.
  # Therefore, don't use this definition of cmd:
